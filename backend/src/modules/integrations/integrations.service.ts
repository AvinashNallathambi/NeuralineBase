...
export const DEFAULT_INTEGRATIONS: IntegrationDefinition[] = [
  ...
  },
  {
    ...
    description: 'Free FDA drug data — NDC directory (all FDA-approved drugs including gene therapies), drug labels, adverse events, and recalls.',
  ...
  {
    key: 'dailymed',
    name: 'DailyMed Prescribing Labels',
    description: 'Free FDA-approved prescribing information (SPL labels) with full indications, warnings, and dosage instructions.',
    provider: 'NLM DailyMed',
    icon: '📋',
    enabled: false,
    category: 'clinical',
    requiresOAuth: false,
  ...
  {
    key: 'nppes_pharmacy',
    name: 'NPPES Pharmacy Directory',
    description: 'Free CMS NPI Registry — search all 60,000+ US pharmacies by name, city, state, or zip. No API key required.',
    provider: 'CMS NPPES',
    icon: '🏪',
    enabled: false,
    category: 'pharmacy',
  ...
  },
  {
    ...
    icon: '/integrations/ringcentral.png',
    enabled: false,
    category: 'communication',
    requiresOAuth: true,
    configurable: true,
  ...
  },
  {
    ...
    provider: 'Microsoft',
    icon: '/integrations/ms-teams.png',
    enabled: false,
    category: 'video',
    requiresOAuth: true,
    configurable: true,
  },
  {
    ...
    provider: 'Google',
    icon: '/integrations/google-meet.png',
    enabled: false,
    category: 'video',
    requiresOAuth: true,
    configurable: true,
