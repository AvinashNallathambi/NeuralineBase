...
@Module({
  ...
  providers: [HipaaAuditService, EncryptionService, PasswordPolicyService, TenantWipeService, StorageService],
  exports: [HipaaAuditService, EncryptionService, PasswordPolicyService, TenantWipeService, StorageService],
})
